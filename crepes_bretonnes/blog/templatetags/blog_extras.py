...
register = template.Library()  # instance de classe qui nous permettra d’enregistrer nos filtres et tags
"""
def citation(texte):
...
def randomm(parser, token):
    ...
    return RandomNodee(begin, end)

from django.template.base import VariableDoesNotExist

class RandomNodee(template.Node):
    def __init__(self, begin, end):
        self.begin = begin
        self.end = end
